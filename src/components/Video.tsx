            ...
            <div className="p-8 max-w-[1100px] mx-auto">
                <div className="flex itens-start gap-16">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <a href="" className="p-4 text-sm border-blue-500 text-blue-500 flex itens-center rounded font-bold uppercase gap-2 justify-center hover:bg-blue-500 hover:text-gray-900 transition-colors">
                            <Lightning size={24} />
                            Acesse o Desafio
                        </a>
                    </div>
